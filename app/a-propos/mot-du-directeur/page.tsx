      ...
      <div className="container px-4 py-12 md:px-6 md:py-24 flex-grow">
        ...
        <div className="grid gap-8 md:grid-cols-3 mt-12">
          <div className="md:col-span-1">
            <div className="sticky top-24">
              <div className="relative w-full aspect-square rounded-lg overflow-hidden mb-4">
                <Image
                  src="/placeholder.svg?text=Dr.+Amadou+Diallo&height=400&width=400"
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                <h3 className="font-bold text-lg">Dr. Amadou Diallo</h3>
          ...
          <div className="md:col-span-2 space-y-6 text-muted-foreground">
            ...
            <p>
              Depuis sa création en 1998, le CAPEC s'est imposé comme un centre d'excellence en matière d'analyse
            ...
            <p>
              ...
              complexes, le rôle des institutions de recherche comme le CAPEC est plus crucial que jamais. Nous nous
            ...
            <p>
              Le CAPEC entretient des partenariats fructueux avec de nombreuses institutions nationales et
            ...
            <p className="text-xl font-medium text-foreground">
              Je vous remercie de votre intérêt pour le CAPEC et vous souhaite une excellente visite.
            </p>
            <div className="pt-4">
              <p className="font-medium">Dr. Amadou Diallo</p>
              <p>Directeur du CAPEC</p>
            </div>
          </div>
        </div>
      </div>
